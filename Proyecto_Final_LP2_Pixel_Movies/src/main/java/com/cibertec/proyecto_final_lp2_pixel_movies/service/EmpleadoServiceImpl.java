...
public class EmpleadoServiceImpl implements EmpleadoService {
    ...
    public void borrarEmpleado(Integer id) {
        if (empleadoRepository.existsById(id)) {
            ...
            throw new RuntimeException("No se encontr� empleado con el id: " + id);
        }
    }

    @Override
    public Empleados buscarEmpleado(Integer id) {
        return empleadoRepository.findById(id).orElseThrow(() -> new RuntimeException("No se encontr� empleado con el id: " + id));
    }
}